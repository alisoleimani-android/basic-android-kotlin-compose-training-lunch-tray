...
fun LunchTrayApp(
    ...
    val screenTitleResId = LunchTrayScreen.valueOf(
    ...
    Scaffold(
        topBar = {
            LunchTrayAppBar(
                screenTitle = stringResource(id = screenTitleResId),
        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.Start.name) {
                StartOrderScreen(
                    onStartOrderButtonClicked = {
                        navHostController.navigate(LunchTrayScreen.EntreeMenu.name)
                    }
                )
            }
            ...
            composable(route = LunchTrayScreen.EntreeMenu.name) {
                EntreeMenuScreen(
                    ...
                    onNextButtonClicked = { navHostController.navigate(LunchTrayScreen.SideDishMenu.name) },
            ...
            composable(route = LunchTrayScreen.SideDishMenu.name) {
                SideDishMenuScreen(
                    ...
                    onNextButtonClicked = {
                        navHostController.navigate(LunchTrayScreen.AccompanimentMenu.name)
                    },
            ...
            composable(route = LunchTrayScreen.AccompanimentMenu.name) {
                AccompanimentMenuScreen(
                    ...
                    onNextButtonClicked = { navHostController.navigate(LunchTrayScreen.Checkout.name) },
